          ...
          >
            <Card className="w-full max-w-md shadow-2xl">
              <CardBody className="p-6">
                <h3 id="export-dialog-title" className="text-2xl font-bold text-gray-900 mb-4">Export Document</h3>
                ...
                <div className="space-y-3">
                  ...
                  <button
                    ...
                    aria-label="Export as LaTeX format"
                  >
                    <div className="flex items-center gap-3">
                      <span className="text-3xl" aria-hidden="true">📄</span>
                      <div>
                  ...
                  <button
                    ...
                    aria-label="Export as Word Document format"
                  >
                    <div className="flex items-center gap-3">
                      <span className="text-3xl" aria-hidden="true">📘</span>
                      <div>
